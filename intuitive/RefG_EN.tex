...
\hypersetup{
    hidelinks,
    pdfstartview={FitH},
    pdftitle={Refractive Gravity: An Ontological Picture and the Foundations of Mathematical Formalism (Version 3.4)},
    pdfauthor={George Lotishvili}
}

\newcommand{\RefG}{\mathrm{RefG}}

\title{\textbf{Refractive Gravity: An Ontological Picture and the Foundations of Mathematical Formalism}\\[0.5em]\large Version 3.4}
