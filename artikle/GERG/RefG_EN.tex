...
The minimal low-order polynomial response basis in the invariants --- seven
terms, with a single phase--solid mixing term --- is
\begin{align*}
F_{\rm min}={}&
...
matches Schwarzschild through first post-Newtonian order and, in the time
component, through $O(m^2/r^2)$, departing at second order in the spatial
sector. Its Einstein tensor has the mixed diagonal profile
\[
G^t{}_t=-D,\qquad
G^r{}_r=+D,\qquad
