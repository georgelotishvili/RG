...
exterior geodesic numbers quoted in this paper is new; they are used with
...
programs \cite{Yilmaz1958} --- either involve a ghost degree of freedom or
work outside the standard field-equation framework. A healthy field-theoretic source for this geometry,
...
\]
so the second-order optical coefficient is $q_{2{\rm PN}}=7/4$. The values
