...
The same action contains the technical background channel used for local stability and for the weak-Solar branch. The combination
\[
C_6=Y+2I_1-I_3
\]
and the invariant
...
q_{2{\rm PN}}=\frac{7}{4}.
\]
Restricted zero-stress and dark-energy-scale checks test this branch separation. The compact phase branch is a separate strong-field exterior; its observational signatures are the shadow and innermost stable circular orbit (ISCO) quantities derived below.
