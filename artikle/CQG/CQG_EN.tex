...
matched pure-phase exterior, while other higher-sector operators are assumed
subleading or vanishing on this branch and would define beyond-core corrections
if retained.
...
predictions the required window is
\[
1<Q_\star<2,\qquad
...
exterior window used by the geodesic predictions. When it holds, the compact
phase branch gives definite static branch predictions:
\[
r_{\rm ph}=r_s,\qquad
b_c=e\,r_s,\qquad
