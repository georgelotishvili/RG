...
The compact static branch uses an exponential exterior. This metric form has an independent literature, including its historical association with Yilmaz's gravitational theory \cite{Yilmaz1958} and its analysis as a traversable-wormhole geometry \cite{Boonserm2018}; strong-field alternatives to GR provide the comparison setting \cite{Damour1992,Damour1993,Damour1996}. RefG uses this metric form as the phase-spherical compact exterior, not Yilmaz's field equations or source prescription: the source is the projected phase-pressure deficit stress and the Einstein-equation residual is checked explicitly below.
