...
Branch labels are controlled by compactness and boundary matching: weak sources keep the diffuse Solar stress contribution, while the static compact predictions apply to $C^2$-matched ultradense sources whose exterior selects the phase-pressure-deficit branch.
