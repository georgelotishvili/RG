...
\item \textbf{Effective closure of the fine-structure constant ($\alpha$):} The constant $\alpha$ is read as the ratio between internal phase--topological locking and external electromagnetic readout; an effective boundary calculation gives this relation numerical form.
...
In the effective $\alpha$ map of RefG, the fine-structure constant is read as the ratio between internal resonant locking and external electromagnetic readout.
...
In this system, the fine-structure constant $\alpha$ is the electromagnetic readout of the phase--topological locking of a charged oscillon. The quantitative targets of this channel are Maxwell's equations, Gauss's law, charge conservation, $E=\hbar\omega$, bosonic statistics, the creation and annihilation of a free photon, and the mirror self-conjugacy of its two helicity states.
...
The fine-structure constant, $\alpha\approx1/137$, is one of the well-known mysteries of physics---Feynman regarded it as one of the greatest unexplained numbers of theoretical physics \citep{feynman1985}. RefG reads $\alpha$ as the relation between the internal phase--topological locking of a charged oscillon and its external electromagnetic readout.
...
The effective boundary computational chain gives $\alpha^{-1}=137.035999174\ldots$ \citep{lotishvili2026a}. The observed $\alpha$ and the lepton mass ratios were used to select the branch and the law; the resulting number measures the internal consistency of this effective boundary closure.
...
\bibliography{Intuitive_Article_EN_DRAFT}
